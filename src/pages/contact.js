                ...
                <div className="bg-dark dark:bg-light rounded-3xl translate-x-3 translate-y-3">
                    <motion.div
                        ...
                        <div className="p-5 sm:p-10 lg:w-[55%]">
                            <form action="" className="space-y-4" onMouseOver={() => isHovered("hovered")} onMouseLeave={() => isHovered("default")}>
                                <div>
                                    <label className="sr-only" htmlFor="name">Name</label>
                                    <input
                                        className="w-full rounded-lg border-dark/80 dark:border-light/80 p-3 text-sm bg-light dark:bg-dark dark:placeholder:text-slate-400"
                                        placeholder="Name"
                                        type="text"
                                        id="name"
                                    />
                                ...
                                <div className="mt-4">
                                    <button
                                        type="submit"
                                        className="inline-block w-full rounded-lg bg-dark dark:bg-light px-5 py-3 font-medium text-light dark:text-dark sm:w-auto"
                                        onMouseOver={() => isHovered("hovered")} onMouseLeave={() => isHovered("default")}
                                    >
                                        Send Enquiry
                                    </button>
